...
####
#About
expander_beta = st.beta_expander("About")
expander_beta.markdown('''
* **Python Libraries :**base 64 , pandas , streamlit , numpy , matplotlib ,seaborn ,BeatifulSoup,requests,json , time
* **Data Source :** [CoinMarketCap](http://coinmarketcap.com).
* **Credit :** Web Scraper adapted from the Meduim Article *[Web Scraping Crypto Prices With Python](https://towardsdatascience.com/web-scraping-crypto-prices-with-python-41072ea5b5bf)* written by [Bryan Feng](https://medium.com/@bryanf).
''')
